...
//	private static final String url = "http://localhost:8080/<userid>_Labo4Opdracht1/";
	private static final String url = "http://localhost:8080/Aantal_letters/";
...
//		 Voor mac: 
	...
	public void test_Count_papa_a_geeft_2 () {
		driver.get(url+"Numb?woord=papa&letter=a");
	...
	public void test_Count_tennis_s_geeft_1 () {
		driver.get(url+"Numb?woord=tennis&letter=s");
		String antwoord = driver.findElement(By.id("antwoord")).getText();
	...
	public void test_Count_mama_p_geeft_0 () {
		driver.get(url+"Numb?woord=mama&letter=p");
		String antwoord = driver.findElement(By.id("antwoord")).getText();
	...
	public void test_Count_Acradabra_a_geeft_4 () {
		driver.get(url+"Numb?woord=Acradabra&letter=a");
		String antwoord = driver.findElement(By.id("antwoord")).getText();
